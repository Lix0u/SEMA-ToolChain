...
class PluginHooks: # TODO replace with classses
    def __init__(self):
        ...
        self.internal_functions_hooks = {
                ...
                #5356518bd88b730c85f6750433c0eb266a008d44240450568b4314508b0350e80ce8ffff85c07507e83be8ffffeb0233c033d289530c5a5e5bc3
    ...
    def hook(self,state,proj,call_sim):
        for fun in self.hooks.keys():
            if fun == "copy" or fun == "copy_2":
                ...
                print("\n\n\n crc32 hook : "+ str(len(self.internal_functions_hooks[fun]))+" \n\n\n\n")
                proj.hook(
                    self.hooks[fun],
